                ...
                <form action="account_settings.php" method="post" enctype="multipart/form-data">
                    <tr class="r1">
                        ...
                        <td class="covet_img"> <span>
                                <h4>Chang Cover Pic :<h4> <input type="file" name="cover_pic" id="cover"> <input
                                            type="submit" name="submit_cover_pic" value="Sublit"> <input type="submit"
                                            style="background: darkorange;" value="Cancel">
                            </span> </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr class="r2">
                        ...
                        <td> <span style="margin-top: 0px; margin-left: 182px;">
                                <h4>Chang Profile Pic :<h4> <input type="file" name="profile_pic" id="profile"><input
                                            type="submit" name="submit_profile_pic" value="Sublit"> <input type="submit"
                                            style="background: darkorange;" value="Cancel">
                            </span> </td>
                    </tr>
                    <tr>
                    ...
                    <tr class="r4">
                        ...
                        <td> <input type="text" name="Fname" id="Fname"> <input type="submit" name="submit_Fname"
                                value="Edit"> <input type="submit" style="background: darkorange;" value="Cancel"> <?php if (in_array("Fail to update First name" , $error_array)) echo "<br>Fail to update First name"; elseif (in_array("First name Updated :)" , $error_array)) { echo "<br>First name update :)"; } 
                    ?> </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr class="r5">
                        ...
                        <td> <input type="text" name="Lname" id="Lname"> <input type="submit" name="submit_Lname"
                                value="Edit"> <input type="submit" style="background: darkorange;" value="Cancel">
