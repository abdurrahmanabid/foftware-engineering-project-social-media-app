...
<body>
    ...
    <div class="page_wreper">
        <center>
            <div class="heading">
                <span style="color: white; font-size: 28px;">Hello <b><?php echo $user['adminname'] ?> !</b> Welcom to
                    Admin Penal :)</span><a href="logout.php"><button>Logout</button></a>
            </div>
        </center>
        <center>
            <div class="total">
                ...
                <div class="t_post">
                    <div class="t_post_wreper">
                        ...
                        <span style="font-size: 22px; font-family: system-ui; color: white; ">Total Posts</span> <br>
                        <span style="font-size: 25px; color: white; "> <?php echo $count_post; ?> </span>
                    </div>
                </div>
            </div>
        </center>
        <div class="main" style="margin-top: 50px;">
            <center>
                <div>
                    <input type="submit" class="l_user" for="user" name="user" onClick='javascript:show()'
                        value="Remove User">
                </div>
            ...
            <center>
                <div>
                    <input type="submit" class="l_post" for="Post" onClick='javascript:show2()' name="Post"
                        value="Remove Post">
                </div>
            ...
            <center>
                <div>
                    <input type="submit" class="l_msg" for="Post" onClick='javascript:show3()' name="Post"
            ...
            <center>
                <div>
                    <input type="submit" class="l_comment" for="Post" onClick='javascript:show4()' name="Post"
