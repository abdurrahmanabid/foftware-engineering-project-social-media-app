...
<?php
    ...
    if(isset($_POST['post'])){
        ...
        if($uploadOk){
            $post = new MyPosted($con, $userLoggedIn);
        ...
        <div class="post-inner">
            ...
            <div class="post-body">
                <form class="post_form" action="index.php" method="POST" enctype="multipart/form-data">
                    <textarea class="status" name="post_text" id="post_text" placeholder="Type Something here!" rows="4"
                        cols="50"></textarea>
                    <div class="hash-box">
                        <ul>
                        </ul>
            ...
            <div class="post-footer">
                <div class="p-fo-left">
                    <ul>
                        ...
                        <label for="fileToUpload"> <img src="assets/images/camera.png" alt="" height="30px"></i>
                        </label>
