...
<head>
    ...
    <title>Wellcome to CozyConnect</title>
...
<body>
    ...
    <div class="top-content">
        <h1 style="font-size:35px; color:black;">Wellcome to CozyConnect</h1>
        </p>
    </div>

    <div class="wreper" style="">
        <div class="signin-form" id="signin">
            ...
            <div class="form-bottom">
                <form action="register.php" method="POST" class="login-form">
                    ...
                    <span class="pswd_icon_bg" onclick="log_pswd_toggale()"><i class="fa-regular fa-eye" id="pswd_show"
                            style="margin: auto;"></i></span>
                    <input type="password" id="login_pswd" name="log_password" placeholder="Password" required>

                    <!-- remember me -->
                    <span>Not registration yet?</span><a href="#signup" id="control">sing-up</a>
            ...
            <div class="signup-form" id="signup">
                ...
                <div class="form-bottom">
                    ...
                    ?>
                        ...
                        <span class="pswd_icon_bg" onclick="reg_pswd_toggale()"><i class="fa-regular fa-eye"
                                id="reg_pswd_show" style="margin: auto;"></i></span>
                    ...
                    ?>
                        ...
                        <span class="pswd_icon_bg" onclick="reg_conf_pswd_toggale()"><i class="fa-regular fa-eye"
                                id="reg_conf_pswd_show" style="margin: auto;"></i></span>
    ...
    <footer>
        <div class="footer">
            <a style="text-decoration-line: none; color: #977AFF;" href="admin.php"><i class="fas fa-user-shield"></i>
                Admin? click here <i class="fas fa-arrow-right"></i></a>
            <p> ©2020 All Rights Reserved <BR> Website designed and developed by <strong><U>Sindhiya Mahesh</u></strong>
            </p>
        </div>
    </footer>-->
