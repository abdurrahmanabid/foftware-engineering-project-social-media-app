...
<body>
    ...
    if ($result->num_rows > 0) {
        echo "<table><tr><th>ID</th><th>Comment</th><th>By</th><th>To</th><th>Post ID</th></tr>";
        while($row = $result->fetch_assoc()) {
            echo "<tr><td>".$row["id"]."</td><td>".$row["post_body"]."</td><td>".$row["posted_by"]."</td><td>".$row["posted_to"]."</td><td>".$row["post_id"]."</td></tr>";
        }
        echo "</table>";
    } else {
        echo "0 results";
